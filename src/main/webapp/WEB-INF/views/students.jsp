        ...
        <tags:inner>
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-11">
                            <h2 class="no-margin-bottom">Ученики</h2>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" data-toggle="modal" data-target="#edit-modal"
                                                       data-action="/students/${user.id}/edit" data-login="${user.login}"
...
<div id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Редактировать ученика</h4>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
            </div>
            <form>
                <div class="modal-body">
