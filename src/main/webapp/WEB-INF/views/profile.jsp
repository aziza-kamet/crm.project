...
<html>
<head>
    <title>CRM | ${user.name} ${user.surname}</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group-material">
                                                            ...
                                                            <label for="name" class="label-material active">Имя</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group-material">
                                                            <input id="surname" type="text" name="surname" required class="input-material" value="${user.surname}">
                                                            <label for="surname" class="label-material active">Фамилия</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
